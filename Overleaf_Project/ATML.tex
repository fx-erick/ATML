...
\begin{figure}[h]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[width = 0.25\linewidth]{figures/alpha.png}
        \label{}
    \end{subfigure}%
    \begin{subfigure}
        \centering
        \includegraphics[width = 0.25\linewidth]{figures/learning_rate.png}
        \label{}
    \end{subfigure}\\
    \begin{subfigure}
        \centering
        \includegraphics[width = 0.25\linewidth]{figures/temperature.png}
        \label{}
    \end{subfigure}%
    \begin{subfigure}
        \centering
        \includegraphics[width = 0.25\linewidth]{figures/soft_coupling_temperature.png}
        \label{}
    \end{subfigure}
    \caption{}
